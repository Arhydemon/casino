    ...
    def build_wheel_background(self):
        return [
            ...
            ft.Container(
                ...
                left=(WHEEL_SIZE - INNER_CIRCLE_SIZE) / 2,
                top=(WHEEL_SIZE - INNER_CIRCLE_SIZE) / 2,
                border_radius=INNER_CIRCLE_SIZE / 2,
